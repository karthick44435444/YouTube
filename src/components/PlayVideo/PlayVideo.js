                    ...
                    <div className="details-col-4">
                      <div className="details-video-description">
                        <p className="discription">
                          YouTube channel description may be something as simple
                          as: “new videos every Friday!” Alternatively, you
                          could note a more detailed schedule: “We post how-to
                          videos every Monday, unboxing videos every Wednesday,
                          and giveaways on Friday!”
                        </p>
                      </div>
                    </div>
